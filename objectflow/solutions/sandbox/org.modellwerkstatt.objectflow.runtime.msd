...
<solution name="org.modellwerkstatt.objectflow.runtime" uuid="5a857198-951d-4874-b213-66fc66e0ee10" moduleVersion="0">
  <models>
  ...
  <facets>
    <facet type="java" languageLevel="JAVA_8" compile="mps" classes="mps" ext="no">
      ...
      <library location="${module}/jars/basis/mo-javaxbus-1.0.jar" />
      <library location="${module}/jars/printing21/barcode4j-fop-ext-complete.jar" />
      <library location="${module}/jars/printing21/fop.jar" />
      <library location="${module}/jars/richclient/ojdbc8.jar" />
      <library location="${module}/jars/printing21/fontbox-2.0.24.jar" />
      <library location="${module}/jars/richclient/activation-1.1.jar" />
      <library location="${module}/jars/basis/spring-aop-5.3.27.jar" />
      <library location="${module}/jars/printing21/xmlgraphics-commons-2.8.jar" />
      <library location="${module}/jars/printing21/commons-io-2.13.0.jar" />
